...
TeamPilot 是一个面向中小团队的项目与任务进度管理系统，包含项目管理、任务看板、人员管理、进展汇总、巡检报告和多种 AI 辅助能力。
...
- AI 辅助：任务分配建议、任务估时、任务拆解、项目计划生成、巡检报告、风险分析、会签建议、项目复盘
- 报告发送：巡检报告支持日报 07:00、周报周五 12:30 自动更新，手动刷新和 SMTP 邮件发送
